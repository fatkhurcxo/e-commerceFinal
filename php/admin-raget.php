...
<body>
    <div class="container-fluid">
        <div class="row" style="box-sizing: border-box;">
            <div class="col-1 container-fluid" style="background-color: #FF5786;">
                <aside class="side-control d-flex flex-column">
                    <div class="">
                    </div>
                    <div class="">
                    </div>
            ...
            <div class="col-11 bg-light">
                <nav class="top-navigasi d-flex justify-content-between p-3 align-items-center">
                    <div class="nav-logo">
                        <a href="">
                    ...
                    <div class="admin-card card text-end">
                        <div class="card-body">
                            <h5>
                                Fatkhur Rozak
                            </h5>
                            <p>
                                Admin Raget Bags Store Candi
                            </p>
                            <form action="" method="POST">
                                <button type="submit" name="log-out" class="btn btn-outline-danger">Log Out</button>
                            </form>
                        </div>
                    </div>
                </nav>

                <div class="nav-btn container-fluid d-flex mt-3">
                    <div class="add-mhs">
                        <!-- BUTTON BUAT AKUN TRIGGER -->
                        <button class="btn btn-success btn-register" data-bs-toggle="modal" data-bs-target="#modal-insert">
                            Add product
                        </button>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel">
                                    <span class="ms-3 text-success">Detail Product</span>
                                </h1>
                                ...
                                <div class="modal-body container-fluid">
                                    <div class="input-group">
                                        <div class="form-group container">
                                            <label for="usernameInput" class="mb-2"><span style="font-weight: bold;">Product
                                                    Name</span></label>
                                            <input type="text" id="usernameInput" class="form-control" placeholder="Nama produk" name="product_name" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="input-group mt-3">
                                        <div class="form-group container">
                                            <label for="usernameInput" class="mb-2"><span style="font-weight: bold;">Product Price</span></label>
                                            <input type="text" id="usernameInput" class="form-control" placeholder="Harga produk" name="produk_price" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="input-group mt-3">
                                        <div class="form-group container">
                                            <label for="usernameInput" class="mb-2"><span style="font-weight: bold;">Product Varian</span></label>
                                            <input type="text" id="usernameInput" class="form-control" placeholder="Varian produk" name="product_varian" required>
                                        </div>
                                    </div>
                                    <div class="input-group mt-3">
                                        <div class="form-group container">
                                            <label for="usernameInput" class="mb-2"><span style="font-weight: bold;">Product Image</span></label>
                                            <input type="text" id="usernameInput" class="form-control" placeholder="Varian produk" name="product_image" required>
                                        </div>
                                    </div>
                                    <!-- <div class="input-group mt-3 mb-3">
                                        <div class="form-group container">
                                            <label for="formFileMultiple" class="form-label fw-bold">Product Image</label>
                                            <input class="form-control-sm form-control" type="file" id="formFileMultiple" multiple>
                                        </div>
                                    </div> -->
                                    <div class="container modal-footer">
                                        <button type="submit" class="btn container btn-success" data-bs-dismiss="modal" name="add">Add</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="container-fluid mt-3">
                    <?php foreach ($product as $row) : ?>
                        <div class="dsg-data-mhs d-flex justify-content-between align-items-center rounded border p-1 pe-3 ps-3 mt-3">
                            <div class="profile-mhs">
                                <img class="img-fluid" src="../img-assets/product/<?php echo $row["product_image"]; ?>" alt="" width="100px">
                            </div>
                            <div class="name-mhs" style="width: 175px;">
                                <h6><?php echo $row["product_name"]; ?></h6>
                            </div>
                            <div class="semester-mhs" style="width: 150px;">
                                <h6><?php echo $row["product_price"]; ?></h6>
                                <!-- $data_mhs['semester']; ?> -->
                            </div>
                            <div class="gender-mhs" style="width: 150px;">
                                <h6><?php echo $row["product_color"]; ?></h6>
                                <!--  $data_mhs['jenis_kelamin']; ?> -->
                            </div>
                            <div class="option-mhs">
                                <button class="change-data btn btn-outline-warning ms-2">Change</button>
                                <a class="delete-data btn btn-outline-danger ms-2" href="delete.php?product_id=<?= $row['product_id']; ?>">Delete</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
