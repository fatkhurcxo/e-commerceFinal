                ...
                <div class="row row-cols-2 container-fluid border p-3 border rounded bg-light">
                    <div class="col-4 d-flex justify-content-center align-items-center">
                        <div class="profile-container">
                            <img class="img-fluid border-primary rounded-circle" src="../img-assets/user-profile/<?= $tableAkun["avatar"]; ?>" alt="">
                        </div>
                    </div>
                    <div class="col-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="bg-bg-white">
                                        <a target="_blank" href="https://api.whatsapp.com/send?phone=6285604276781&text=Apa%20barang%20ini%20tersedia?%20<?= $produkData["nama"]; ?>" class="btn rounded-0 border button-chat container">
